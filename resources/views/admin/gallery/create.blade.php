...
@section('subtitle', 'Tambah foto baru ke galeri website')
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="col-span-2">
                    ...
                    <select name="kategori"
                            class="w-full text-sm border border-gray-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-yellow-400 @error('kategori') border-red-400 @enderror">
