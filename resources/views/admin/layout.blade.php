...
<head>
    ...
    <title>@yield('title', 'Admin') — BUKYUK VILLA</title>
...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 text-white flex flex-col shadow-2xl">
        ...
        <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
            ...
            {{-- PERTEMUAN 13: @can 'lihat-laporan' → staff & admin tampil, guest tidak --}}
            @can('lihat-laporan')
            ...
            {{-- PERTEMUAN 13: @can 'kelola-kamar' → hanya admin yang lihat menu ini --}}
            @can('kelola-kamar')
            <a href="{{ route('admin.rooms.index') }}" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm
               {{ request()->routeIs('admin.rooms*') ? 'bg-yellow-500 text-gray-900 font-semibold shadow-lg' : 'text-gray-300 hover:bg-white/10 hover:text-white' }}">
        ...
        {{-- User & Logout — PERTEMUAN 12: tampilkan nama & role user yang login --}}
        <div class="px-3 py-4 border-t border-white/10">
            <div class="flex items-center gap-3 px-3 py-2 mb-2">
                ...
                <div>
                    ...
                    {{-- PERTEMUAN 12 & 13: tampilkan badge role --}}
