        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow duration-300 group">
                <div class="relative overflow-hidden">
                    <img src="/images/Deluxe.jpg" class="w-full h-60 object-cover group-hover:scale-105 transition-transform duration-500" alt="Classic Room">
                ...
                <div class="p-5 text-sm">
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        <div>
                            ...
                            <p class="text-yellow-600 font-semibold text-base">Rp 850.000 <span class="text-xs text-gray-400 font-normal">/ night</span></p>
                        </div>
                        <button class="bg-yellow-600 text-white px-4 py-2 text-xs hover:bg-yellow-700 transition rounded-sm">
                            BOOK NOW
                        </button>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow duration-300 group">
                <div class="relative overflow-hidden">
                    <img src="/images/Family.jpg" class="w-full h-60 object-cover group-hover:scale-105 transition-transform duration-500" alt="Deluxe Room">
                    <div class="absolute top-3 left-3 bg-yellow-600 text-white text-xs px-3 py-1 rounded-sm tracking-widest">
                        DELUXE
                    </div>
                </div>
                <div class="p-5 text-sm">
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        <div>
                            <p class="text-xs text-gray-400">Start from</p>
                            <p class="text-yellow-600 font-semibold text-base">Rp 1.200.000 <span class="text-xs text-gray-400 font-normal">/ night</span></p>
                        </div>
                        <button class="bg-yellow-600 text-white px-4 py-2 text-xs hover:bg-yellow-700 transition rounded-sm">
                            BOOK NOW
                        </button>
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow duration-300 group">
                <div class="relative overflow-hidden">
                    <img src="/images/Presidential.jpg" class="w-full h-60 object-cover group-hover:scale-105 transition-transform duration-500" alt="Superior Room">
                    <div class="absolute top-3 left-3 bg-yellow-600 text-white text-xs px-3 py-1 rounded-sm tracking-widest">
                        SUPERIOR
                    </div>
                </div>
                <div class="p-5 text-sm">
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        <div>
                            <p class="text-xs text-gray-400">Start from</p>
                            <p class="text-yellow-600 font-semibold text-base">Rp 1.500.000 <span class="text-xs text-gray-400 font-normal">/ night</span></p>
                        </div>
                        <button class="bg-yellow-600 text-white px-4 py-2 text-xs hover:bg-yellow-700 transition rounded-sm">
                            BOOK NOW
                        </button>
