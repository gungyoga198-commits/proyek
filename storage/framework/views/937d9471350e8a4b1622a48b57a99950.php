...
<main>
    ...
    <section class="bg-gray-100 py-20 px-10">
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow">
                <img src="/images/Deluxe.jpg" class="w-full h-56 object-cover" alt="">
            ...
            <!-- CARD 2 -->
            <div class="bg-white rounded-lg overflow-hidden shadow">
                <img src="/images/Family.jpg" class="w-full h-56 object-cover" alt="">
                <div class="p-4 text-sm">
            ...
            <!-- CARD 3 -->
            <div class="bg-white rounded-lg overflow-hidden shadow">
                <img src="/images/Presidential.jpg" class="w-full h-56 object-cover" alt="">
                <div class="p-4 text-sm">
    ...
    <div class="flex justify-end px-10 py-4 bg-gray-100 border-t border-gray-200">
        <a href="<?php echo e(route('admin.login')); ?>"
            class="text-xs text-gray-400 hover:text-yellow-600 transition">
            Login Admin
        </a>
    </div>

</main><?php /**PATH C:\laragon\www\proyek\resources\views/components/hero.blade.php ENDPATH**/ ?>