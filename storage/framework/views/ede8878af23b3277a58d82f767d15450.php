<?php $__env->startSection('title', 'Edit Kamar: ' . $room->nama); ?>
<?php $__env->startSection('subtitle', 'Update data kamar di database'); ?>
...
<div class="max-w-3xl">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 bg-yellow-50">
            <h3 class="font-semibold text-gray-800">✏️ Edit Kamar: <?php echo e($room->nama); ?></h3>
            <p class="text-xs text-gray-500 mt-0.5">ID: <?php echo e($room->id); ?> · Dibuat: <?php echo e($room->created_at->format('d M Y')); ?></p>
        </div>
        ...
        <form action="<?php echo e(route('admin.rooms.update', $room)); ?>" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="nama" value="<?php echo e(old('nama', $room->nama)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="tipe" value="<?php echo e(old('tipe', $room->tipe)); ?>"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="harga_per_malam"
                           value="<?php echo e(old('harga_per_malam', $room->harga_per_malam)); ?>"
                           min="0" step="50000"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="ukuran" value="<?php echo e(old('ukuran', $room->ukuran)); ?>"
                           class="w-full text-sm border border-gray-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-yellow-400">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tipe Bed</label>
                    <input type="text" name="tipe_bed" value="<?php echo e(old('tipe_bed', $room->tipe_bed)); ?>"
                           class="w-full text-sm border border-gray-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-yellow-400">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Pemandangan</label>
                    <input type="text" name="pemandangan" value="<?php echo e(old('pemandangan', $room->pemandangan)); ?>"
                           class="w-full text-sm border border-gray-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-yellow-400">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="3"
                          class="w-full text-sm border border-gray-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-yellow-400 resize-none"><?php echo e(old('deskripsi', $room->deskripsi)); ?></textarea>
            </div>
                ...
                <div class="grid grid-cols-3 gap-2">
                    ...
                    <label class="flex items-center gap-2 text-sm text-gray-600 cursor-pointer">
                        <input type="checkbox" name="fasilitas[]" value="<?php echo e($fasilitas); ?>"
                               <?php echo e(in_array($fasilitas, old('fasilitas', $room->fasilitas ?? [])) ? 'checked' : ''); ?>
            ...
            <div>
                ...
                <div class="mb-2">
                    ...
                    <p class="text-xs text-gray-400 mt-1">Gambar saat ini: <?php echo e($room->gambar); ?></p>
                </div>
                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center gap-3">
                <input type="checkbox" name="is_active" id="is_active"
                       <?php echo e(old('is_active', $room->is_active) ? 'checked' : ''); ?>
    ...
    <div class="mt-4 bg-blue-50 border border-blue-100 rounded-xl p-4 text-xs text-blue-700">
        ...
        <p>Total reservasi: <strong><?php echo e($room->reservations()->count()); ?></strong></p>
        <p>Reservasi aktif: <strong><?php echo e($room->reservasiAktif()->count()); ?></strong></p>
    </div>
    <?php endif; ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\proyek\resources\views/admin/rooms/edit.blade.php ENDPATH**/ ?>