                    ...
                    <div class="p-6 flex flex-col justify-between">
                        ...
                        <div>
                            ...
                            <div class="flex items-start justify-between mb-2">
                                <div>
                                    <h3 class="text-xl font-semibold text-gray-800"><?php echo e($room->nama); ?></h3>
                                    <p class="text-xs text-gray-400 mt-0.5 tracking-wide">
                                        <?php echo e($room->ukuran ?? ''); ?><?php echo e(($room->ukuran && $room->pemandangan) ? ' · ' : ''); ?><?php echo e($room->pemandangan ?? ''); ?>
                            ...
                            <div class="grid grid-cols-2 gap-2 mb-4">
                                <div class="flex items-center gap-2 text-xs text-gray-500">
                                    ...
                                    <span><?php echo e($room->kapasitas ?? 2); ?> Tamu</span>
                                </div>
                                <div class="flex items-center gap-2 text-xs text-gray-500">
                                    <svg class="w-4 h-4 text-yellow-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex flex-wrap gap-1.5 mb-5">
                                ...
                                <span class="bg-gray-50 border border-gray-200 text-gray-400 text-xs px-2.5 py-1 rounded-full">
                                    +<?php echo e(count($fasilitas) - 5); ?> lainnya
                                </span>
                                <?php endif; ?>
                            </div>
                        </div>
...
</main><?php /**PATH C:\laragon\www\proyek\resources\views/components/rooms.blade.php ENDPATH**/ ?>