...
<?php $__env->startSection('subtitle', 'Riwayat dan statistik reservasi hotel'); ?>

<?php $__env->startSection('content'); ?>


<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
    <form action="<?php echo e(route('admin.laporan')); ?>" method="GET" class="flex flex-wrap gap-4 items-end">
        <div>
        ...
        <div class="flex gap-2">
            ...
            <a href="<?php echo e(route('admin.laporan')); ?>" class="bg-gray-100 text-gray-600 px-5 py-2.5 rounded-xl text-sm hover:bg-gray-200 transition">
                Reset
            </a>
        </div>
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
        ...
        <p class="text-3xl font-bold text-gray-800"><?php echo e($reservations->count()); ?></p>
    ...
    <div class="bg-white rounded-2xl border border-green-100 shadow-sm p-5">
        ...
        <p class="text-2xl font-bold text-green-600">Rp <?php echo e(number_format($totalPendapatan/1000000,1)); ?>jt</p>
    ...
    <div class="bg-white rounded-2xl border border-blue-100 shadow-sm p-5">
        ...
        <p class="text-2xl font-bold text-blue-600">
            Rp <?php echo e($reservations->count() > 0 ? number_format($totalPendapatan/$reservations->count()/1000,0).'rb' : '0'); ?>
    ...
    <div class="bg-white rounded-2xl border border-red-100 shadow-sm p-5">
        ...
        <p class="text-3xl font-bold text-red-500"><?php echo e($reservations->where('status','cancelled')->count()); ?></p>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-gray-400 mt-0.5"><?php echo e($reservations->count()); ?> data ditemukan</p>
        </div>
    </div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50/50 transition">
                    ...
                    <td class="px-5 py-4">
                        <p class="font-medium text-gray-800"><?php echo e($r->nama_lengkap); ?></p>
                        <p class="text-xs text-gray-400"><?php echo e($r->email); ?></p>
                    </td>
                    <td class="px-5 py-4 text-gray-600 text-xs"><?php echo e($r->jenis_kamar); ?></td>
                    <td class="px-5 py-4 text-gray-600 text-xs whitespace-nowrap"><?php echo e($r->check_in->format('d M Y')); ?></td>
                    <td class="px-5 py-4 text-gray-600 text-xs whitespace-nowrap"><?php echo e($r->check_out->format('d M Y')); ?></td>
                    <td class="px-5 py-4 text-center text-gray-600"><?php echo e($r->jumlah_malam); ?></td>
                    <td class="px-5 py-4 font-semibold text-gray-700 whitespace-nowrap">Rp <?php echo e(number_format($r->total_harga,0,',','.')); ?></td>
                    <td class="px-5 py-4 text-gray-500 text-xs capitalize"><?php echo e(str_replace('_',' ',$r->metode_pembayaran)); ?></td>
                    <td class="px-5 py-4"><span class="px-2.5 py-1 rounded-full text-xs font-semibold <?php echo e($badge); ?>"><?php echo e($label); ?></span></td>
                </tr>
            ...
            <tfoot class="border-t-2 border-gray-200 bg-gray-50">
                <tr>
                    ...
                    <td colspan="3" class="px-5 py-4 text-sm font-bold text-green-600">Rp <?php echo e(number_format($totalPendapatan,0,',','.')); ?></td>
                </tr>
            </tfoot>
            <?php endif; ?>
        </table>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\proyek\resources\views/admin/laporan.blade.php ENDPATH**/ ?>