...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 text-white flex flex-col shadow-2xl">
        ...
        <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
            ...
            <a href="<?php echo e(route('admin.gallery.index')); ?>" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm
               <?php echo e(request()->routeIs('admin.gallery*') ? 'bg-yellow-500 text-gray-900 font-semibold shadow-lg' : 'text-gray-300 hover:bg-white/10 hover:text-white'); ?>">
