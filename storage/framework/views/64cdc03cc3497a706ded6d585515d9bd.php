...
<div class="grid grid-cols-2 md:grid-cols-4 gap-5 mb-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-blue-100 p-5">
        ...
        <p class="text-3xl font-bold text-blue-600"><?php echo e($confirmed); ?></p>
...
<div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-8 flex items-center justify-between">
    <div class="flex items-center gap-3">
        ...
        <p class="text-sm text-yellow-700 font-medium">Ada <strong><?php echo e($pending); ?></strong> reservasi menunggu konfirmasi Anda.</p>
    </div>
    <a href="<?php echo e(route('admin.reservasi', ['status' => 'pending'])); ?>"
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100">
    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
        ...
        <a href="<?php echo e(route('admin.reservasi')); ?>" class="text-xs text-yellow-600 hover:underline">Lihat Semua →</a>
    </div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-6 py-4 font-mono text-xs text-yellow-600 font-semibold"><?php echo e($r->kode_booking); ?></td>
                    <td class="px-6 py-4 font-medium"><?php echo e($r->nama_lengkap); ?></td>
                    <td class="px-6 py-4 text-gray-600"><?php echo e($r->jenis_kamar); ?></td>
                    <td class="px-6 py-4 text-gray-600"><?php echo e($r->check_in->format('d M Y')); ?></td>
                    <td class="px-6 py-4">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\proyek\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>