...
<?php $component = App\View\Components\Gallery::resolve(['galleries' => $galleries,'kategoris' => $kategoris,'kategori' => $kategori] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
